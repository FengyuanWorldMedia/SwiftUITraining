...
public class SrDemoImageLoader {
    ...
    // let imageUrl = "http://192.168.0.3:8080/mock/webapi/file/download?file_id=8ca5321dc3206be28bb29afff3d14795"
    public static func loadImage(file_id : String,
        ...
        SrDemoImageLoader.loadImage(url: imageUrl,
